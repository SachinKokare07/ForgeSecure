...
const updateIncidentStatus = async (req, res) => {
  try {
    ...
    const updatedLog = await Log.findByIdAndUpdate(id, { incidentStatus }, { new: true });

    req.io.emit("incident-updated", updatedLog);
...
module.exports = { receiveDeviceData, getLogs, updateIncidentStatus };